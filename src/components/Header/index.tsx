          ...
          >
            ...
            <defs className={styles.defs}>
              <linearGradient id="b">
                ...
                <stop offset="0.2" stopColor="#7b7bd1" />
                <stop offset="0.4" stopColor="#f7a1d0" />
                <stop offset="0.6" stopColor="#f27373" />
              </linearGradient>
            </defs>
            <path
              fill="url(#b)"
            ...
            />
            <g fill="none" stroke="#E2E9E9" strokeWidth="1" className="group">
